...
<div class="table-responsive">
		...
		<table class="table">
			...
			<c:if test="${board.category=='notice' }">
				<tr>
					<th colspan="4"><input class="btn btn-default" type="button" value="목록으로"	onclick="location.href='adminBoardNotice.do?pageNum=${pageNum}'">
									<input class="btn btn-default" type="button" value="글삭제" onclick="deleteBoard('${board.category}')"></th>
				</tr>
			</c:if>
			<c:if test="${board.category != 'notice' }">
				<tr>
					<th colspan="4"><input class="btn btn-default" type="button" value="목록으로"	onclick="location.href='adminBoardFree.do?pageNum=${pageNum}'">
									<input class="btn btn-default" type="button" value="글삭제" onclick="deleteBoard('${board.category}')">
