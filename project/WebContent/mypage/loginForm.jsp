...
<table>
	...
	<tr><th colspan=2><input class="btn btn-default" type=submit value=로그인 ></th></tr>
</table>
</form>

<hr>
<div id="foot">아직 중앙도서관 회원이 아니십니까?
<button onclick="location.href=''../member/joinForm.jsp'" class="btn btn-default">회원가입하기</button></div> 

<div id="find">
<a href="../login/findID.jsp">아이디 찾기</a> &nbsp; | &nbsp; <a href="../login/findPass.jsp">비밀번호 찾기</a>
</div>
